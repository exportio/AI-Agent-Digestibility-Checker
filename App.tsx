    ...
    <div className="min-h-screen text-gray-900 selection:bg-brand-200">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 transition-all duration-300 bg-[#E2EF99]/80 backdrop-blur-md border-b border-white/20">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2 font-display font-bold text-xl tracking-tight cursor-pointer" onClick={() => window.scrollTo({top: 0, behavior: 'smooth'})}>
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-700">
            ...
            <button 
              ...
              className="px-5 py-2.5 bg-white text-gray-900 rounded-full shadow-sm hover:shadow-md transition-all font-semibold"
            >
              Analyze Website
            </button>
          </div>
      ...
      <main className="relative">
        ...
        {/* Analyzer Section (Main Functionality) */}
        <div className="bg-white/50 backdrop-blur-sm rounded-t-[3rem] -mt-10 pt-10 border-t border-white/40 min-h-[400px]">
           <Analyzer />
        </div>
