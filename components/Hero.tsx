          ...
          <div className="relative z-10 grid grid-cols-2 gap-6 p-4">
            ...
            <Card className="col-span-2 shadow-xl !rounded-[2.5rem] transform hover:-translate-y-1 transition-transform duration-500">
              ...
              <div className="space-y-4">
                {steps.map((step, idx) => (
                  <div key={idx} className={`flex items-center justify-between p-3 rounded-xl transition-all duration-500 ${scanStep === idx
            ...
            <Card className="absolute right-0 -top-8 md:-right-8 md:-top-12 w-48 !p-4 shadow-lg animate-float-slow opacity-90 hidden sm:block">
            ...
            <Card className="absolute left-0 -bottom-8 md:-left-12 md:bottom-20 w-56 !p-4 shadow-lg animate-float-delayed opacity-90 scale-90 md:scale-100 origin-bottom-left">
